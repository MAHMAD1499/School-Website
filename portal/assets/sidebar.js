...
function buildSidebar(role = 'portal') {
  ...
  if (isAdmin) {
    ...
    userSection = staff ? `<div class="sidebar-section-label">Teachers Portal</div>` : '';
    ...
    <div class="portal-sidebar" id="portalSidebar">
      <a href="${isAdmin ? '../index.php' : isStudent ? '../index.php' : isStaff ? '../index.php' : 'index.php'}" class="sidebar-brand">
        ...
        <div class="sidebar-brand-text">
          ...
          <span class="brand-sub">${isAdmin ? 'Admin Panel' : isStudent ? 'Student Panel' : isStaff ? 'Staff Panel' : 'School Portal'}</span>
        </div>
      </a>
      ${userSection}
