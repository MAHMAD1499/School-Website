...
<head>
  ...
  <meta name="description" content="Latest news and announcements from Kindergarten Saadia's Montessori School.">
  <title>News & Announcements — KSM Portal</title>
  ...
  function renderNews() {
    ...
    list.innerHTML = news.map(n => `
      <div class="news-card">
        ...
        ${n.body.length > 180 ? `<button class="btn btn-sm btn-outline" style="margin-top:0.75rem;" onclick="openNews('${n.id}')">ℹ️ Read More</button>` : ''}
      </div>
    `).join('');
  }
